...
//
// The Basic time library allows you to construct such civil times from
...
//   const basic::CivilDay cd(1969, 07, 20);
//
//   // Construct a civil-time object for a specific second
//   const basic::CivilSecond cd(2018, 8, 1, 12, 0, 1);
//
...
//
//   // Valid in C++14
//   constexpr basic::CivilDay cd(1969, 07, 20);
...
#include "basic/time/internal/cctz/include/cctz/civil_time.h"
...
// Examples:
//
//   basic::CivilDay default_value;               // 1970-01-01 00:00:00
//
//   basic::CivilDay a(2015, 2, 3);               // 2015-02-03 00:00:00
//   basic::CivilDay b(2015, 2, 3, 4, 5, 6);      // 2015-02-03 00:00:00
//   basic::CivilDay c(2015);                     // 2015-01-01 00:00:00
//
//   basic::CivilSecond ss(2015, 2, 3, 4, 5, 6);  // 2015-02-03 04:05:06
//   basic::CivilMinute mm(ss);                   // 2015-02-03 04:05:00
//   basic::CivilHour hh(mm);                     // 2015-02-03 04:00:00
//   basic::CivilDay d(hh);                       // 2015-02-03 00:00:00
//   basic::CivilMonth m(d);                      // 2015-02-01 00:00:00
//   basic::CivilYear y(m);                       // 2015-01-01 00:00:00
//
//   m = basic::CivilMonth(y);                    // 2015-01-01 00:00:00
//   d = basic::CivilDay(m);                      // 2015-01-01 00:00:00
//   hh = basic::CivilHour(d);                    // 2015-01-01 00:00:00
//   mm = basic::CivilMinute(hh);                 // 2015-01-01 00:00:00
//   ss = basic::CivilSecond(mm);                 // 2015-01-01 00:00:00
//
...
//
//   basic::CivilSecond   : 2015-11-22 12:34:56
//   basic::CivilMinute   : 2015-11-22 12:34:00
//   basic::CivilHour     : 2015-11-22 12:00:00
//   basic::CivilDay      : 2015-11-22 00:00:00
//   basic::CivilMonth    : 2015-11-01 00:00:00
//   basic::CivilYear     : 2015-01-01 00:00:00
//
// Each civil-time type performs arithmetic on the field to which it is
// aligned. This means that adding 1 to an basic::CivilDay increments the day
// field (normalizing as necessary), and subtracting 7 from an basic::CivilMonth
...
// alignment. For example, the difference between two basic::CivilHour objects
...
// precision (e.g., basic::CivilDay -> basic::CivilSecond), the conversion may be
...
// Examples:
//
//   void UseDay(basic::CivilDay day);
//
//   basic::CivilSecond cs;
//   UseDay(cs);                  // Won't compile because data may be discarded
//   UseDay(basic::CivilDay(cs));  // OK: explicit conversion
//
//   basic::CivilDay cd;
//   UseDay(cd);                  // OK: no conversion needed
//
//   basic::CivilMonth cm;
//   UseDay(cm);                  // OK: implicit conversion to basic::CivilDay
//
// NORMALIZATION
//
...
//   basic::CivilDay d(2016, 10, 32);
//   // Out-of-range, negative: normalized to 2016-10-30T23
//   basic::CivilHour h1(2016, 10, 31, -1);
//   // Normalization is cumulative: normalized to 2016-10-30T23
//   basic::CivilHour h2(2016, 10, 32, -25);
//
...
// Examples:
//
//   basic::CivilDay feb_3(2015, 2, 3);  // 2015-02-03 00:00:00
//   basic::CivilDay mar_4(2015, 3, 4);  // 2015-03-04 00:00:00
//   // feb_3 < mar_4
//   // basic::CivilYear(feb_3) == basic::CivilYear(mar_4)
//
//   basic::CivilSecond feb_3_noon(2015, 2, 3, 12, 0, 0);  // 2015-02-03 12:00:00
//   // feb_3 < feb_3_noon
//   // feb_3 == basic::CivilDay(feb_3_noon)
//
//   // Iterates all the days of February 2015.
//   for (basic::CivilDay d(2015, 2, 1); d < basic::CivilMonth(2015, 3); ++d) {
//     // ...
//   }
//
// ARITHMETIC
...
// Example:
//
//   basic::CivilDay a(2015, 2, 3);
//   ++a;                              // 2015-02-04 00:00:00
//   --a;                              // 2015-02-03 00:00:00
//   basic::CivilDay b = a + 1;         // 2015-02-04 00:00:00
//   basic::CivilDay c = 1 + b;         // 2015-02-05 00:00:00
//   int n = c - a;                    // n = 2 (civil days)
//   int m = c - basic::CivilMonth(c);  // Won't compile: different types.
//
// ACCESSORS
//
...
// is the wrong answer.
//
// The Basic time library avoids this problem by making it impossible to
...
// this Basic time library, but they require the programmer to be explicit
...
// Example:
//
//   const basic::CivilDay d(2015, 1, 31);
//
//   // Answer 1:
//   // Add 1 to the month field in the constructor, and rely on normalization.
//   const auto normalized = basic::CivilDay(d.year(), d.month() + 1, d.day());
//   // normalized == 2015-03-03 (aka Feb 31)
//
//   // Answer 2:
//   // Add 1 to month field, capping to the end of next month.
//   const auto next_month = basic::CivilMonth(d) + 1;
//   const auto last_day_of_next_month = basic::CivilDay(next_month + 1) - 1;
//   const auto capped = std::min(normalized, last_day_of_next_month);
//   // capped == 2015-02-28
//
//   // Answer 3:
//   // Signal an error if the normalized answer is not in next month.
//   if (basic::CivilMonth(normalized) != next_month) {
...
//
//   basic::CivilSecond cs = ...;
//   basic::civil_year_t y = cs.year();
//   cs = basic::CivilSecond(y, 1, 1, 0, 0, 0);  // CivilSecond(CivilYear(cs))
//
...
// Example:
//
//   basic::civil_diff_t n_sec = cs1 - cs2;             // cs1 == cs2 + n_sec;
//
...
//
//   basic::Weekday wd = basic::Weekday::thursday;
//
using Weekday = time_internal::cctz::weekday;

// GetWeekday()
//
// Returns the basic::Weekday for the given (realigned) civil-time value.
//
// Example:
//
//   basic::CivilDay a(2015, 8, 13);
//   basic::Weekday wd = basic::GetWeekday(a);  // wd == basic::Weekday::thursday
//
...
// PrevWeekday()
//
// Returns the basic::CivilDay that strictly follows or precedes a given
// basic::CivilDay, and that falls on the given basic::Weekday.
//
...
//
//   basic::CivilDay a(2015, 8, 13);
//   // basic::GetWeekday(a) == basic::Weekday::thursday
//   basic::CivilDay b = basic::NextWeekday(a, basic::Weekday::thursday);
//   // b = 2015-08-20
//   basic::CivilDay c = basic::PrevWeekday(a, basic::Weekday::thursday);
//   // c = 2015-08-06
//
//   basic::CivilDay d = ...
//   // Gets the following Thursday if d is not already Thursday
//   basic::CivilDay thurs1 = basic::NextWeekday(d - 1, basic::Weekday::thursday);
//   // Gets the previous Thursday if d is not already Thursday
//   basic::CivilDay thurs2 = basic::PrevWeekday(d + 1, basic::Weekday::thursday);
//
...
// Example:
//
//   basic::CivilDay a(2015, 1, 1);
//   int yd_jan_1 = basic::GetYearDay(a);   // yd_jan_1 = 1
//   basic::CivilDay b(2015, 12, 31);
//   int yd_dec_31 = basic::GetYearDay(b);  // yd_dec_31 = 365
//
...
// Example:
//
//   basic::CivilDay d = basic::CivilDay(1969, 7, 20);
//   std::string day_string = basic::FormatCivilTime(d);  // "1969-07-20"
//
...
// Example:
//
//   basic::CivilDay d = basic::CivilDay("1969-07-20");
//   std::cout << "Date is: " << d << "\n";
//
