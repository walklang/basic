...
// Now()
//
// Returns the current time, expressed as an `basic::Time` absolute time value.
basic::Time Now();

// GetCurrentTimeNanos()
//
// Returns the current time, expressed as a count of nanoseconds since the Unix
// Epoch (https://en.wikipedia.org/wiki/Unix_time). Prefer `basic::Now()` instead
...
// SleepFor()
//
// Sleeps for the specified duration, expressed as an `basic::Duration`.
//
// Notes:
// * Signal interruptions will not reduce the sleep duration.
// * Returns immediately when passed a nonpositive duration.
void SleepFor(basic::Duration duration);
...
// check.
extern "C" {
void AbslInternalSleepFor(basic::Duration duration);
}  // extern "C"

inline void basic::SleepFor(basic::Duration duration) {
