#!/usr/bin/python
"""Generate Basic compile compile option configs.

Usage: <path_to_basic>/copts/generate_copts.py
...
def file_header_lines():
  return [
      ...
      "(1) Edit basic/copts/copts.py.",
      "(2) Run `python <path_to_basic>/copts/generate_copts.py`."
  ]
...
class CMakeStyle(object):
  ...
  def filename(self):
    return "GENERATED_BasicCopts.cmake"
