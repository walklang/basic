...
TEST(Uint128, OStreamValueTest) {
  ...
  CheckUint128Case(
      {basic::MakeUint128(1, 0), kDec, /*width = */ 0, "18446744073709551616"});
  CheckUint128Case({basic::MakeUint128(1, 0), kOct, /*width = */ 0,
                    "2000000000000000000000"});
  CheckUint128Case(
      {basic::MakeUint128(1, 0), kHex, /*width = */ 0, "10000000000000000"});
  CheckUint128Case({basic::MakeUint128(0x8000000000000000, 0), kDec,
                    /*width = */ 0, "170141183460469231731687303715884105728"});
  CheckUint128Case({basic::MakeUint128(0x8000000000000000, 0), kOct,
                    /*width = */ 0,
                    "2000000000000000000000000000000000000000000"});
  CheckUint128Case({basic::MakeUint128(0x8000000000000000, 0), kHex,
                    /*width = */ 0, "80000000000000000000000000000000"});
  CheckUint128Case({basic::kuint128max, kDec, /*width = */ 0,
                    "340282366920938463463374607431768211455"});
  CheckUint128Case({basic::kuint128max, kOct, /*width = */ 0,
                    "3777777777777777777777777777777777777777777"});
  CheckUint128Case({basic::kuint128max, kHex, /*width = */ 0,
