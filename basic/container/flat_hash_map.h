...
// -----------------------------------------------------------------------------
//
// An `basic::flat_hash_map<K, V>` is an unordered associative container of
...
// -----------------------------------------------------------------------------
//
// An `basic::flat_hash_map<K, V>` is an unordered associative container which
...
//
// By default, `flat_hash_map` uses the `basic::Hash` hashing framework.
...
// consider using `basic::flat_hash_map<Key, std::unique_ptr<Value>>` instead.
// If your types are not moveable or you require pointer stability for keys,
// consider `basic::node_hash_map`.
//
// Example:
//
//   // Create a flat hash map of three strings (that map to strings)
//   basic::flat_hash_map<std::string, std::string> ducks =
...
//  }
template <class K, class V,
          class Hash = basic::container_internal::hash_default_hash<K>,
          class Eq = basic::container_internal::hash_default_eq<K>,
          class Allocator = std::allocator<std::pair<const K, V>>>
class flat_hash_map : public basic::container_internal::raw_hash_map<
                          basic::container_internal::FlatHashMapPolicy<K, V>,
                          Hash, Eq, Allocator> {
 ...
 public:
  ...
  //    basic::flat_hash_map<int, std::string> map1;
  //
  // * Initializer List constructor
  //
  //   basic::flat_hash_map<int, std::string> map2 =
  //       {{1, "huey"}, {2, "dewey"}, {3, "louie"},};
  //
  // * Copy constructor
  //
  //   basic::flat_hash_map<int, std::string> map3(map2);
  //
  // * Copy assignment operator
  //
  //  // Hash functor and Comparator are copied as well
  //  basic::flat_hash_map<int, std::string> map4;
  //  map4 = map3;
  //
  // * Move constructor
  //
  //   // Move is guaranteed efficient
  //   basic::flat_hash_map<int, std::string> map5(std::move(map4));
  //
  // * Move assignment operator
  //
  //   // May be efficient if allocators are compatible
  //   basic::flat_hash_map<int, std::string> map6;
  //   map6 = std::move(map5);
  //
  // * Range constructor
  //
  //   std::vector<std::pair<int, std::string>> v = {{1, "a"}, {2, "b"}};
  //   basic::flat_hash_map<int, std::string> map7(v.begin(), v.end());
  flat_hash_map() {}
  using Base::Base;
  ...
  //
  // NOTE: this member function is particular to `basic::flat_hash_map` and is
...
struct IsUnorderedContainer<
    basic::flat_hash_map<Key, T, Hash, KeyEqual, Allocator>> : std::true_type {};
