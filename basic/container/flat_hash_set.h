...
// -----------------------------------------------------------------------------
//
// An `basic::flat_hash_set<T>` is an unordered associative container designed to
...
// -----------------------------------------------------------------------------
//
// An `basic::flat_hash_set<T>` is an unordered associative container which has
...
//
// By default, `flat_hash_set` uses the `basic::Hash` hashing framework. All
// fundamental and Basic types that support the `basic::Hash` framework have a
...
// `basic::flat_hash_set<std::unique_ptr<T>>`. If your type is not moveable and
// you require pointer stability, consider `basic::node_hash_set` instead.
//
// Example:
//
//   // Create a flat hash set of three strings
//   basic::flat_hash_set<std::string> ducks =
//     {"huey", "dewey", "louie"};
//
...
class flat_hash_set
    : public basic::container_internal::raw_hash_set<
          basic::container_internal::FlatHashSetPolicy<T>, Hash, Eq, Allocator> {
 ...
 public:
  ...
  //    basic::flat_hash_set<std::string> set1;
  //
  // * Initializer List constructor
  //
  //   basic::flat_hash_set<std::string> set2 =
  //       {{"huey"}, {"dewey"}, {"louie"},};
  //
  // * Copy constructor
  //
  //   basic::flat_hash_set<std::string> set3(set2);
  //
  // * Copy assignment operator
  //
  //  // Hash functor and Comparator are copied as well
  //  basic::flat_hash_set<std::string> set4;
  //  set4 = set3;
  //
  // * Move constructor
  //
  //   // Move is guaranteed efficient
  //   basic::flat_hash_set<std::string> set5(std::move(set4));
  //
  // * Move assignment operator
  //
  //   // May be efficient if allocators are compatible
  //   basic::flat_hash_set<std::string> set6;
  //   set6 = std::move(set5);
  //
  // * Range constructor
  //
  //   std::vector<std::string> v = {"a", "b"};
  //   basic::flat_hash_set<std::string> set7(v.begin(), v.end());
  flat_hash_set() {}
  using Base::Base;
  ...
  //
  // NOTE: this member function is particular to `basic::flat_hash_set` and is
...
struct FlatHashSetPolicy {
  ...
  static void construct(Allocator* alloc, slot_type* slot, Args&&... args) {
    basic::allocator_traits<Allocator>::construct(*alloc, slot,
                                                 std::forward<Args>(args)...);
  }

  template <class Allocator>
  static void destroy(Allocator* alloc, slot_type* slot) {
    basic::allocator_traits<Allocator>::destroy(*alloc, slot);
  }
...
struct IsUnorderedContainer<basic::flat_hash_set<Key, Hash, KeyEqual, Allocator>>
    : std::true_type {};
