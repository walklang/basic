...
using ThrowerVec = basic::InlinedVector<Thrower, kInlinedCapacity>;
using MovableThrowerVec = basic::InlinedVector<MovableThrower, kInlinedCapacity>;

using ThrowAllocThrowerVec =
    basic::InlinedVector<Thrower, kInlinedCapacity, ThrowAlloc>;
using ThrowAllocMovableThrowerVec =
    basic::InlinedVector<MovableThrower, kInlinedCapacity, ThrowAlloc>;
...
TYPED_TEST(OneSizeTest, MoveConstructor) {
  ...
  if (!basic::allocator_is_nothrow<allocator_type>::value) {
