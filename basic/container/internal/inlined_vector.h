...
using IsMemcpyOk = basic::conjunction<
    std::is_same<std::allocator<typename AllocatorType::value_type>,
                 AllocatorType>,
    basic::is_trivially_copy_constructible<typename AllocatorType::value_type>,
    basic::is_trivially_copy_assignable<typename AllocatorType::value_type>,
    basic::is_trivially_destructible<typename AllocatorType::value_type>>;

template <typename AllocatorType, typename ValueType, typename SizeType>
void DestroyElements(AllocatorType* alloc_ptr, ValueType* destroy_first,
                     SizeType destroy_size) {
  using AllocatorTraits = basic::allocator_traits<AllocatorType>;
...
class Storage {
 public:
  ...
  using AllocatorTraits = basic::allocator_traits<allocator_type>;
 ...
 private:
  ...
  struct Inlined {
    using InlinedDataElement =
        basic::aligned_storage_t<sizeof(value_type), alignof(value_type)>;
...
auto Storage<T, N, A>::Assign(ValueAdapter values, size_type new_size) -> void {
  ...
  basic::Span<value_type> assign_loop;
  basic::Span<value_type> construct_loop;
  basic::Span<value_type> destroy_loop;
...
auto Storage<T, N, A>::Resize(ValueAdapter values, size_type new_size) -> void {
  ...
  basic::Span<value_type> construct_loop;
  basic::Span<value_type> move_construct_loop;
  basic::Span<value_type> destroy_loop;
