...
#include "basic/base/internal/bits.h"
#include "basic/base/internal/endian.h"
#include "basic/base/port.h"
#include "basic/container/internal/common.h"
#include "basic/container/internal/compressed_tuple.h"
#include "basic/container/internal/container_memory.h"
#include "basic/container/internal/hash_policy_traits.h"
#include "basic/container/internal/hashtable_debug_hooks.h"
#include "basic/container/internal/hashtablez_sampler.h"
#include "basic/container/internal/have_sse.h"
#include "basic/container/internal/layout.h"
...
class raw_hash_set {
 ...
 public:
  ...
  using pointer = typename basic::allocator_traits<
      allocator_type>::template rebind_traits<value_type>::pointer;
  using const_pointer = typename basic::allocator_traits<
 ...
 private:
  ...
  using Layout = basic::container_internal::Layout<ctrl_t, slot_type>;
  ...
  using AllocTraits = basic::allocator_traits<allocator_type>;
  using SlotAlloc = typename basic::allocator_traits<
      allocator_type>::template rebind_alloc<slot_type>;
  using SlotAllocTraits = typename basic::allocator_traits<
  ...
  using RequiresInsertable = typename std::enable_if<
      basic::disjunction<std::is_convertible<T, init_type>,
 ...
 public:
  ...
  class iterator {
   ...
   public:
    ...
    using reference =
        basic::conditional_t<PolicyTraits::constant_iterators::value,
                            const value_type&, value_type&>;
    using pointer = basic::remove_reference_t<reference>*;
  ...
  //   // copies the strings into the set.
  //   basic::flat_hash_set<std::string> s = {"abc", "def"};
  //
  ...
  raw_hash_set(raw_hash_set&& that) noexcept(
      ...
      : ctrl_(basic::exchange(that.ctrl_, EmptyGroup())),
        slots_(basic::exchange(that.slots_, nullptr)),
        size_(basic::exchange(that.size_, 0)),
        capacity_(basic::exchange(that.capacity_, 0)),
        infoz_(basic::exchange(that.infoz_, HashtablezInfoHandle())),
  ...
  raw_hash_set& operator=(raw_hash_set&& that) noexcept(
      basic::allocator_traits<allocator_type>::is_always_equal::value&&
 ...
 private:
  ...
  friend struct basic::container_internal::hashtable_debug_internal::
 ...
 private:
  ...
  basic::container_internal::CompressedTuple<size_t /* growth_left */, hasher,
...
struct HashtableDebugAccess<Set, basic::void_t<typename Set::raw_hash_set>> {
