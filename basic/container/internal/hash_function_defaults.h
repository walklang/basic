...
// The hash of an object of type T is computed by using basic::Hash.
template <class T, class E = void>
struct HashEq {
  using Hash = basic::Hash<T>;
...
struct StringHash {
  ...
  size_t operator()(basic::string_view v) const {
    return basic::Hash<basic::string_view>{}(v);
  }
};
...
struct StringHashEq {
  ...
  struct Eq {
    using is_transparent = void;
    bool operator()(basic::string_view lhs, basic::string_view rhs) const {
      return lhs == rhs;
    }
  };
};
...
template <>
struct HashEq<basic::string_view> : StringHashEq {};
...
struct HashEq<T*> {
  struct Hash {
    ...
    size_t operator()(const U& ptr) const {
      return basic::Hash<const T*>{}(HashEq::ToPtr(ptr));
    }
  };
  struct Eq {
    using is_transparent = void;
...
//
// Example: typename Hash = typename basic::flat_hash_map<K, V>::hasher
template <class T>
...
//
// Example: typename Eq = typename basic::flat_hash_map<K, V, Hash>::key_equal
template <class T>
