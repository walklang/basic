...
template <class Map>
struct IsMap<Map, basic::void_t<typename Map::mapped_type>> : std::true_type {};
...
template <>
struct Generator<basic::string_view> {
  basic::string_view operator()() const;
};
...
template <class U>
struct Generator<U, basic::void_t<decltype(std::declval<U&>().key()),
