...
using FixedArr = basic::FixedArray<Thrower, kInlined>;

using MoveThrower = testing::ThrowingValue<testing::TypeSpec::kNoThrowMove>;
using MoveFixedArr = basic::FixedArray<MoveThrower, kInlined>;
...
TEST(FixedArrayExceptionSafety, InitListConstructor) {
  ...
  using SmallFixedArr = basic::FixedArray<Thrower, small_inlined>;
