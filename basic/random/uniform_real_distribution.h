...
//
// `basic::uniform_real_distribution` is a drop-in replacement for the C++11
...
// `basic::uniform_real_distribution` does not exhibit this behavior.
...
#include "basic/random/internal/iostream_state_saver.h"

namespace basic {

// basic::uniform_real_distribution<T>
//
...
//   // and 1.0 (exclusive).
//   int value = basic::uniform_real_distribution<double>(0, 1)(gen);
//
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(std::is_floating_point<RealType>::value,
                  "Class-template basic::uniform_real_distribution<> must be "
