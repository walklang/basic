...
// basic::gaussian_distribution implements the Ziggurat algorithm
...
// basic::gaussian_distribution_base implements the underlying ziggurat algorithm
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(
        ...
        "Class-template basic::gaussian_distribution<> must be parameterized "
