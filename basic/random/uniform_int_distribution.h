...
//
// `basic::uniform_int_distribution` is a drop-in replacement for the C++11
...
// basic::uniform_int_distribution<T>
//
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(std::is_integral<result_type>::value,
                  "Class-template basic::uniform_int_distribution<> must be "
