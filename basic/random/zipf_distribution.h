...
// basic::zipf_distribution produces random integer-values in the range [0, k],
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(std::is_integral<IntType>::value,
                  "Class-template basic::zipf_distribution<> must be "
...
zipf_distribution<IntType>::param_type::param_type(
  ...
  // TODO(basic-team): Determine if this check is needed, and if so, add a test
...
zipf_distribution<IntType>::operator()(
  ...
  basic::uniform_real_distribution<double> uniform_double;
  double k;
  for (;;) {
