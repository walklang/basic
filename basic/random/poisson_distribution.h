  ...
  class param_type {
   ...
   private:
    ...
    static_assert(std::is_integral<IntType>::value,
                  "Class-template basic::poisson_distribution<> must be "
...
poisson_distribution<IntType>::param_type::param_type(double mean)
  ...
  if (mean_ < 10) {
    ...
    log_k_ = lmu_ * mode - basic::random_internal::StirlingLogFactorial(mode);
  }
}
...
poisson_distribution<IntType>::operator()(
  ...
  for (;;) {
    ...
    double s = (x <= 1.0) ? 0.0
             ...
             : basic::random_internal::StirlingLogFactorial(x);
    // clang-format on
