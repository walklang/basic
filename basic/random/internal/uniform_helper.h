...
// are used as implementation-details for basic::Uniform().
//
// Conceptually,
...
typename basic::enable_if_t<
    basic::conjunction<
        ...
        basic::disjunction<std::is_same<Tag, IntervalOpenClosedT>,
...
typename basic::enable_if_t<
    basic::disjunction<std::is_same<Tag, IntervalClosedClosedT>,
...
typename basic::enable_if_t<
    basic::conjunction<
        std::is_integral<IntType>,
        basic::disjunction<std::is_same<Tag, IntervalClosedOpenT>,
                          std::is_same<Tag, IntervalOpenOpenT>>>::value,
    IntType>
