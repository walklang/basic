...
TEST(SeedSequences, CheckInterfaces) {
  ...
  // Basic classes
  EXPECT_TRUE(ConformsToInterface<basic::random_internal::ExplicitSeedSeq>());
}
...
TEST(ExplicitSeedSeq, DefaultConstructorGeneratesZeros) {
  ...
  basic::random_internal::ExplicitSeedSeq seq;
...
TEST(ExplicitSeeqSeq, SeedMaterialIsForwardedIdentically) {
  ...
  basic::random_internal::ExplicitSeedSeq seq(seed_material,
...
TEST(ExplicitSeedSeq, CopyAndMoveConstructors) {
  ...
  basic::random_internal::ExplicitSeedSeq seq_from_entropy(std::begin(entropy),
                                                          std::end(entropy));
  // Copy constructor.
  {
    basic::random_internal::ExplicitSeedSeq seq_copy(seq_from_entropy);
  ...
  // Assignment operator.
  {
    ...
    basic::random_internal::ExplicitSeedSeq another_seq(std::begin(entropy),
                                                       std::end(entropy));
  ...
  // Move constructor.
  {
    ...
    basic::random_internal::ExplicitSeedSeq moved_seq(
