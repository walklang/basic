...
//
#include "basic/random/internal/randen.h"
...
#include "basic/random/internal/nanobenchmark.h"
#include "basic/random/internal/platform.h"
#include "basic/random/internal/randen_engine.h"
#include "basic/random/internal/randen_hwaes.h"
#include "basic/random/internal/randen_slow.h"
#include "basic/strings/numbers.h"

namespace {

using basic::random_internal::Randen;
using basic::random_internal::RandenHwAes;
using basic::random_internal::RandenSlow;

using basic::random_internal_nanobenchmark::FuncInput;
using basic::random_internal_nanobenchmark::FuncOutput;
using basic::random_internal_nanobenchmark::InvariantTicksPerSecond;
using basic::random_internal_nanobenchmark::MeasureClosure;
using basic::random_internal_nanobenchmark::Params;
using basic::random_internal_nanobenchmark::PinThreadToCPU;
using basic::random_internal_nanobenchmark::Result;
...
struct Engine {
  mutable basic::random_internal::randen_engine<UInt> rng;
...
void RunAll(const int argc, char* argv[]) {
  if (argc == 2) {
    int cpu = -1;
    if (!basic::SimpleAtoi(argv[1], &cpu)) {
