...
#include "basic/random/internal/distribution_impl.h"
...
ABSL_FLAG(int64_t, basic_random_test_trials, 50000,
          "Number of trials for the probability tests.");

using basic::random_internal::NegativeValueT;
using basic::random_internal::PositiveValueT;
using basic::random_internal::RandU64ToDouble;
using basic::random_internal::RandU64ToFloat;
using basic::random_internal::SignedValueT;
...
TEST(DistributionImplTest, ExhaustiveFloat) {
  using basic::base_internal::CountLeadingZeros64;
  auto ToFloat = [](uint64_t a) {
    return RandU64ToFloat<PositiveValueT, true>(a);
  };
  ...
  size_t limit = basic::GetFlag(FLAGS_basic_random_test_trials);
...
TEST(DistributionImplTest, MultiplyU64ToU128Test) {
  using basic::random_internal::MultiplyU64ToU128;
  constexpr uint64_t k1 = 1;
  constexpr uint64_t kMax = ~static_cast<uint64_t>(0);

  EXPECT_EQ(basic::uint128(0), MultiplyU64ToU128(0, 0));

  // Max uint64
  EXPECT_EQ(MultiplyU64ToU128(kMax, kMax),
            basic::MakeUint128(0xfffffffffffffffe, 0x0000000000000001));
  EXPECT_EQ(basic::MakeUint128(0, kMax), MultiplyU64ToU128(kMax, 1));
  EXPECT_EQ(basic::MakeUint128(0, kMax), MultiplyU64ToU128(1, kMax));
  for (int i = 0; i < 64; ++i) {
    EXPECT_EQ(basic::MakeUint128(0, kMax) << i,
  ...
  for (int i = 0; i < 64; ++i) {
    for (int j = 0; j < 64; ++j) {
      EXPECT_EQ(basic::MakeUint128(0, 1) << (i + j),
  ...
  EXPECT_EQ(MultiplyU64ToU128(0xffffeeeeddddcccc, 0xbbbbaaaa99998888),
            basic::MakeUint128(0xbbbb9e2692c5dddc, 0xc28f7531048d2c60));
  EXPECT_EQ(MultiplyU64ToU128(0x0123456789abcdef, 0xfedcba9876543210),
            basic::MakeUint128(0x0121fa00ad77d742, 0x2236d88fe5618cf0));
  EXPECT_EQ(MultiplyU64ToU128(0x0123456789abcdef, 0xfdb97531eca86420),
            basic::MakeUint128(0x0120ae99d26725fc, 0xce197f0ecac319e0));
  EXPECT_EQ(MultiplyU64ToU128(0x97a87f4f261ba3f2, 0xfedcba9876543210),
            basic::MakeUint128(0x96fbf1a8ae78d0ba, 0x5a6dd4b71f278320));
  EXPECT_EQ(MultiplyU64ToU128(0xfedcba9876543210, 0xfdb97531eca86420),
            basic::MakeUint128(0xfc98c6981a413e22, 0x342d0bbf48948200));
}
