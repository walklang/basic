...
#include "basic/random/internal/distribution_caller.h"
#include "basic/random/internal/traits.h"
#include "basic/random/internal/uniform_helper.h"
...
NumType UniformImpl(TagType tag,
  ...
  static_assert(
      ...
      "basic::Uniform<T>() must use an integer or real parameter type.");

  using distribution_t =
      typename std::conditional<std::is_integral<NumType>::value,
                                basic::uniform_int_distribution<NumType>,
                                basic::uniform_real_distribution<NumType>>::type;
...
// basic::Uniform() will be discarded, and the call will be ill-formed.
// Return-type for basic::Uniform() when the return-type is inferred.
template <typename A, typename B>
using uniform_inferred_return_t =
    basic::enable_if_t<basic::disjunction<is_widening_convertible<A, B>,
