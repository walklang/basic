...
ABSL_MUST_USE_RESULT bool SimpleAtoi(basic::string_view s, int_type* out);
...
ABSL_MUST_USE_RESULT bool SimpleAtof(basic::string_view str, float* out);
...
// allowed formats for `str`. If any errors are encountered, this function
// returns `false`, leaving `out` in an unspecified state.
ABSL_MUST_USE_RESULT bool SimpleAtod(basic::string_view str, double* out);
...
// unspecified state.
ABSL_MUST_USE_RESULT bool SimpleAtob(basic::string_view str, bool* out);
...
// with base different from 10 elsewhere in Basic implementation).
template <typename int_type>
ABSL_MUST_USE_RESULT bool safe_strtoi_base(basic::string_view s, int_type* out,
                                           int base) {
