...
template <typename C, template <typename...> class T>
using IsSpecialization = IsSpecializationImpl<basic::decay_t<C>, T>;
...
template <typename C>
using IsArray = IsArrayImpl<basic::decay_t<C>>;
...
template <typename C>
using IsBitset = IsBitsetImpl<basic::decay_t<C>>;
...
struct IsBaseOfSpecializationImpl<
    C, T, basic::void_t<typename C::value_type, typename C::allocator_type>>
    : std::is_base_of<C,
                      T<typename C::value_type, typename C::allocator_type>> {};
template <typename C, template <typename, typename, typename> class T>
struct IsBaseOfSpecializationImpl<
    C, T,
    basic::void_t<typename C::key_type, typename C::key_compare,
...
struct IsBaseOfSpecializationImpl<
    C, T,
    basic::void_t<typename C::key_type, typename C::mapped_type,
...
struct IsBaseOfSpecializationImpl<
    C, T,
    basic::void_t<typename C::key_type, typename C::hasher,
...
struct IsBaseOfSpecializationImpl<
    ...
    : std::is_base_of<C, T<typename C::key_type, typename C::mapped_type,
                           ...
                           typename C::allocator_type>> {};
template <typename C, template <typename...> class T>
using IsBaseOfSpecialization = IsBaseOfSpecializationImpl<basic::decay_t<C>, T>;
...
template <typename C>
using IsBaseOfArray = IsBaseOfArrayImpl<basic::decay_t<C>>;
...
template <typename C>
using IsBaseOfBitset = IsBaseOfBitsetImpl<basic::decay_t<C>>;

template <typename C>
struct IsBaseOfSTLContainer
    : basic::disjunction<IsBaseOfArray<C>, IsBaseOfBitset<C>,
...
using IsConvertibleToSpecialization =
    IsConvertibleToSpecializationImpl<basic::decay_t<C>, T>;
...
template <typename C>
using IsConvertibleToArray = IsConvertibleToArrayImpl<basic::decay_t<C>>;
...
template <typename C>
using IsConvertibleToBitset = IsConvertibleToBitsetImpl<basic::decay_t<C>>;
...
struct IsStrictlyBaseOfAndConvertibleToSTLContainer
    : basic::conjunction<basic::negation<IsSTLContainer<C>>,
