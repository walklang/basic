...
#include "basic/strings/internal/str_format/arg.h"
#include "basic/strings/internal/str_format/checker.h"
#include "basic/strings/internal/str_format/parser.h"
...
class Streamable {
 public:
  Streamable(const UntypedFormatSpecImpl& format,
    ...
    if (args.size() <= ABSL_ARRAYSIZE(few_args_)) {
      ...
      args_ = basic::MakeSpan(few_args_, args.size());
    } else {
 ...
 private:
  ...
  basic::Span<const FormatArgImpl> args_;
...
bool BindWithPack(const UnboundConversion* props,
                  basic::Span<const FormatArgImpl> pack, BoundConversion* bound);
