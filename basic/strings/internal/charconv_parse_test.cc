...
using basic::chars_format;
using basic::strings_internal::FloatType;
using basic::strings_internal::ParsedFloat;
using basic::strings_internal::ParseFloat;
...
template <int base>
void ExpectParsedFloat(std::string s, basic::chars_format format_flags,
  ...
  if (open_bracket_pos != std::string::npos) {
    ...
    ABSL_RAW_CHECK(close_bracket_pos != basic::string_view::npos,
...
template <int base>
void ExpectNumber(std::string s, basic::chars_format format_flags,
...
void ExpectSpecial(const std::string& s, basic::chars_format format_flags,
                   FloatType type) {
...
template <int base>
void ExpectFailedParse(basic::string_view s, basic::chars_format format_flags) {
  ParsedFloat parsed =
      ParseFloat<base>(s.data(), s.data() + s.size(), format_flags);
