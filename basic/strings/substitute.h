...
//
// Supported types:
//   * basic::string_view, std::string, const char* (null is equivalent to "")
...
// Arg
//
// This class provides an argument type for `basic::Substitute()` and
// `basic::SubstituteAndAppend()`. `Arg` handles implicit conversion of various
...
class Arg {
 public:
  ...
  Arg(const char* value)  // NOLINT(runtime/explicit)
      : piece_(basic::NullSafeStringView(value)) {}
  template <typename Allocator>
  Arg(  // NOLINT
      const std::basic_string<char, std::char_traits<char>, Allocator>&
          value) noexcept
      : piece_(value) {}
  Arg(basic::string_view value)  // NOLINT(runtime/explicit)
      : piece_(value) {}
  ...
  basic::string_view piece() const { return piece_; }

 private:
  basic::string_view piece_;
  char scratch_[numbers_internal::kFastToBufferSize];
};

// Internal helper function. Don't call this from outside this implementation.
// This interface may change without notice.
void SubstituteAndAppendArray(std::string* output, basic::string_view format,
                              const basic::string_view* args_array,
                              size_t num_args);
...
//  void VarMsg(std::string* boilerplate, basic::string_view format,
//      const Args&... args) {
//    basic::SubstituteAndAppend(boilerplate, format, args...);
//  }
//
inline void SubstituteAndAppend(std::string* output, basic::string_view format) {
  substitute_internal::SubstituteAndAppendArray(output, format, nullptr, 0);
}

inline void SubstituteAndAppend(std::string* output, basic::string_view format,
                                const substitute_internal::Arg& a0) {
  const basic::string_view args[] = {a0.piece()};
...
inline void SubstituteAndAppend(std::string* output, basic::string_view format,
  ...
  const basic::string_view args[] = {a0.piece(), a1.piece()};
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
}
...
inline void SubstituteAndAppend(std::string* output, basic::string_view format,
  ...
  const basic::string_view args[] = {a0.piece(), a1.piece(), a2.piece()};
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
}
...
inline void SubstituteAndAppend(
    std::string* output, basic::string_view format,
...
// Example:
//  template <typename... Args>
//  void VarMsg(basic::string_view format, const Args&... args) {
//    std::string s = basic::Substitute(format, args...);

ABSL_MUST_USE_RESULT inline std::string Substitute(basic::string_view format) {
  std::string result;
...
ABSL_MUST_USE_RESULT inline std::string Substitute(
    basic::string_view format, const substitute_internal::Arg& a0) {
  std::string result;
