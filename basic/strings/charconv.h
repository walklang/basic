...
//
// This is an bitfield enumerator which can be passed to basic::from_chars to
...
// Basic's behavior will change to match the standard.  (The behavior most
...
// matching pattern "0".)
basic::from_chars_result from_chars(const char* first, const char* last,
                                   double& value,  // NOLINT
