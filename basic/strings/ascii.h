...
// Creates a lowercase string from a given basic::string_view.
ABSL_MUST_USE_RESULT inline std::string AsciiStrToLower(basic::string_view s) {
  std::string result(s);
  basic::AsciiStrToLower(&result);
  return result;
}
...
// Creates an uppercase string from a given basic::string_view.
ABSL_MUST_USE_RESULT inline std::string AsciiStrToUpper(basic::string_view s) {
  std::string result(s);
  basic::AsciiStrToUpper(&result);
  return result;
}

// Returns basic::string_view with whitespace stripped from the beginning of the
// given string_view.
ABSL_MUST_USE_RESULT inline basic::string_view StripLeadingAsciiWhitespace(
    basic::string_view str) {
  auto it = std::find_if_not(str.begin(), str.end(), basic::ascii_isspace);
...
// Returns basic::string_view with whitespace stripped from the end of the given
// string_view.
ABSL_MUST_USE_RESULT inline basic::string_view StripTrailingAsciiWhitespace(
    basic::string_view str) {
  auto it = std::find_if_not(str.rbegin(), str.rend(), basic::ascii_isspace);
...
// Returns basic::string_view with whitespace stripped from both ends of the
// given string_view.
ABSL_MUST_USE_RESULT inline basic::string_view StripAsciiWhitespace(
    basic::string_view str) {
