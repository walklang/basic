...
// returns "file.cc"
inline basic::string_view Basename(basic::string_view filename) {
  auto last_slash_pos = filename.find_last_of("/\\");

  return last_slash_pos == basic::string_view::npos
             ? filename
...
// returns ""
inline basic::string_view Package(basic::string_view filename) {
  auto last_slash_pos = filename.find_last_of("/\\");
