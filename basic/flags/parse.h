...
// -----------------------------------------------------------------------------
//
// This file defines the main parsing function for Basic flags:
// `basic::ParseCommandLine()`.
...
#include "basic/flags/internal/parse.h"
...
// values to any defined Basic flags. (Any arguments passed after the
// flag-terminating delimiter (`--`) are treated as positional arguments and
// ignored.)
//
// Any command-line flags (and arguments to those flags) are parsed into Basic
