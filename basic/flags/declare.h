...
// `basic::Flag` for use within a translation unit. You should place this
...
// basic::Flag<T> represents a flag of type 'T' created by ABSL_FLAG.
template <typename T>
class Flag;
...
// Flag
//
// Forward declaration of the `basic::Flag` type for use in defining the macro.
template <typename T>
...
// ABSL_DECLARE_FLAG()
//
// This macro is a convenience for declaring use of an `basic::Flag` within a
...
//
//   extern basic::Flag<type> FLAGS_name;
#define ABSL_DECLARE_FLAG(type, name) extern ::basic::Flag<type> FLAGS_##name
