...
#include "basic/debugging/internal/symbolize.h"
...
// (typically obtained through `main()`s `argv[0]`). The Basic symbolizer
...
//     if (basic::Symbolize(pc, tmp, sizeof(tmp))) {
//       symbol = tmp;
//     }
//     basic::PrintF("%*p  %s\n", pc, symbol);
//  }
