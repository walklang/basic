...
// `basic::c_xx(container, ...) are equivalent to std:: functions such as
...
//------------------------------------------------------------------------------
// Basic algorithm.h functions
//------------------------------------------------------------------------------

// c_linear_search()
//
// Container-based version of basic::linear_search() for performing a linear
...
Iterator c_rotate(C& sequence, Iterator middle) {
  return basic::rotate(container_algorithm_internal::c_begin(sequence), middle,
                      container_algorithm_internal::c_end(sequence));
}
...
// basic::decay_t<T>. As a user of this function you can casually read
