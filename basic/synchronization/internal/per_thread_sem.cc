...
#include "basic/synchronization/internal/waiter.h"
...
ABSL_ATTRIBUTE_WEAK void AbslInternalPerThreadSemPost(
    basic::base_internal::ThreadIdentity *identity) {
  basic::synchronization_internal::Waiter::GetWaiter(identity)->Post();
}

ABSL_ATTRIBUTE_WEAK bool AbslInternalPerThreadSemWait(
    basic::synchronization_internal::KernelTimeout t) {
  bool timeout = false;
  basic::base_internal::ThreadIdentity *identity;
  identity = basic::synchronization_internal::GetOrCreateCurrentThreadIdentity();
  ...
  timeout =
      !basic::synchronization_internal::Waiter::GetWaiter(identity)->Wait(t);
