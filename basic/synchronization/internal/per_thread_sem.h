...
class PerThreadSem {
 ...
 private:
  ...
  friend class basic::Mutex;
  friend basic::base_internal::ThreadIdentity* CreateThreadIdentity();
};
...
void basic::synchronization_internal::PerThreadSem::Post(
    basic::base_internal::ThreadIdentity* identity) {
  AbslInternalPerThreadSemPost(identity);
}

bool basic::synchronization_internal::PerThreadSem::Wait(
    basic::synchronization_internal::KernelTimeout t) {
