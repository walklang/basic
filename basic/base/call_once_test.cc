...
basic::once_flag once;

ABSL_CONST_INIT Mutex counters_mu(basic::kConstInit);
...
// Function to be called from basic::call_once.  Waits for a notification.
...
void ThreadBody() {
  ...
  basic::call_once(once, WaitAndIncrement);
