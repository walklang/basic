...
#include "basic/base/internal/thread_annotations.h"  // IWYU pragma: export
...
// cannot be held when calling this function (as Basic's `Mutex` locks are
// non-reentrant).
...
#define ABSL_TS_UNCHECKED_READ(x) basic::base_internal::ts_unchecked_read(x)
