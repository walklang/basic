...
using basic::base_internal::ThrowStdLogicError;
using basic::base_internal::ThrowStdInvalidArgument;
using basic::base_internal::ThrowStdDomainError;
using basic::base_internal::ThrowStdLengthError;
using basic::base_internal::ThrowStdOutOfRange;
using basic::base_internal::ThrowStdRuntimeError;
using basic::base_internal::ThrowStdRangeError;
using basic::base_internal::ThrowStdOverflowError;
using basic::base_internal::ThrowStdUnderflowError;
using basic::base_internal::ThrowStdBadFunctionCall;
using basic::base_internal::ThrowStdBadAlloc;
