...
#include "basic/base/internal/pretty_function.h"
...
constexpr TypeSpec operator|(TypeSpec a, TypeSpec b) {
  using T = basic::underlying_type_t<TypeSpec>;
...
constexpr AllocSpec operator|(AllocSpec a, AllocSpec b) {
  using T = basic::underlying_type_t<AllocSpec>;
...
class TestException {
 public:
  explicit TestException(basic::string_view msg) : msg_(msg) {}
...
class TestBadAllocException : public std::bad_alloc, public TestException {
 public:
  explicit TestBadAllocException(basic::string_view msg) : TestException(msg) {}
...
void MaybeThrow(basic::string_view msg, bool throw_bad_alloc = false);
...
class ThrowingValue : private exceptions_internal::TrackedObject {
 ...
 public:
  ...
  // basic expects nothrow destructors
  ...
  // Basic doesn't support throwing overloaded operator delete.  These are
 ...
 private:
  static std::string GetInstanceString(int dummy) {
    return basic::StrCat("ThrowingValue<",
...
class ThrowingAllocator : private exceptions_internal::TrackedObject {
 ...
 private:
  static std::string GetInstanceString(int dummy) {
    return basic::StrCat("ThrowingAllocator<",
                        exceptions_internal::GetSpecString(Spec), ">(", dummy,
                        ")");
  }
  ...
  void ReadStateAndMaybeThrow(basic::string_view msg) const {
    if (!IsSpecified(AllocSpec::kNoThrowAllocate)) {
      exceptions_internal::MaybeThrow(
          basic::Substitute("Allocator id $0 threw from $1", *dummy_, msg));
    }
  }
...
class DefaultFactory {
 public:
  ...
  std::unique_ptr<T> operator()() const { return basic::make_unique<T>(t_); }
...
using EnableIfTestable = typename basic::enable_if_t<
...
class ExceptionSafetyTestBuilder {
 public:
  ...
  ExceptionSafetyTestBuilder<basic::decay_t<NewFactory>, Operation, Contracts...>
  ...
  ExceptionSafetyTestBuilder<Factory, basic::decay_t<NewOperation>, Contracts...>
  ...
  ExceptionSafetyTestBuilder<Factory, Operation, Contracts...,
                             basic::decay_t<MoreContracts>...>
  WithContracts(const MoreContracts&... more_contracts) const {
    return {
        factory_, operation_,
        std::tuple_cat(contracts_, std::tuple<basic::decay_t<MoreContracts>...>(
                                       more_contracts...))};
  }
  ...
  testing::AssertionResult Test(const NewOperation& new_operation) const {
    return TestImpl(new_operation, basic::index_sequence_for<Contracts...>());
  }
 ...
 private:
  ...
  testing::AssertionResult TestImpl(SelectedOperation selected_operation,
                                    basic::index_sequence<Indices...>) const {
