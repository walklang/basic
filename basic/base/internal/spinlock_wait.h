...
void AbslInternalSpinLockDelay(
    ...
    basic::base_internal::SchedulingMode scheduling_mode);
}

inline void basic::base_internal::SpinLockWake(std::atomic<uint32_t> *w,
                                              bool all) {
  AbslInternalSpinLockWake(w, all);
}

inline void basic::base_internal::SpinLockDelay(
    std::atomic<uint32_t> *w, uint32_t value, int loop,
    basic::base_internal::SchedulingMode scheduling_mode) {
