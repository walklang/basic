...
int CLZ64(uint64_t n) {
  int fast = basic::base_internal::CountLeadingZeros64(n);
  int slow = basic::base_internal::CountLeadingZeros64Slow(n);
...
int CLZ32(uint32_t n) {
  int fast = basic::base_internal::CountLeadingZeros32(n);
  int slow = basic::base_internal::CountLeadingZeros32Slow(n);
  EXPECT_EQ(fast, slow) << n;
  return fast;
}
...
int CTZ64(uint64_t n) {
  int fast = basic::base_internal::CountTrailingZerosNonZero64(n);
  int slow = basic::base_internal::CountTrailingZerosNonZero64Slow(n);
  EXPECT_EQ(fast, slow) << n;
  return fast;
}
...
int CTZ32(uint32_t n) {
  int fast = basic::base_internal::CountTrailingZerosNonZero32(n);
  int slow = basic::base_internal::CountTrailingZerosNonZero32Slow(n);
  EXPECT_EQ(fast, slow) << n;
  return fast;
}
