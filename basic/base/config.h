...
// call. The Basic macro for that feature (`ABSL_HAVE_MMAP`) allows you to
...
#include "basic/base/policy_checks.h"
...
// Basic does not intend to support this indefinitely. Currently, the newest
...
#define ABSL_IS_LITTLE_ENDIAN 1
#else
#error "basic endian detection needs to be set up for your compiler"
#endif
