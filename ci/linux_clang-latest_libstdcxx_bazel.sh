...
readonly DOCKER_CONTAINER="gcr.io/google.com/basic-177019/linux_clang-latest:20190701"
...
if [ ${USE_BAZEL_CACHE:-0} -ne 0 ]; then
  ...
  BAZEL_EXTRA_ARGS="--remote_http_cache=https://storage.googleapis.com/basic-bazel-remote-cache/${container_key} --google_credentials=/keystore/73103_basic-bazel-remote-cache ${BAZEL_EXTRA_ARGS:-}"
fi
  ...
  for compilation_mode in ${COMPILATION_MODE}; do
    ...
    time docker run \
      ...
      /usr/local/bin/bazel test ... \
        ...
        --test_env="TZDIR=/abseil-cpp/basic/time/internal/cctz/testdata/zoneinfo" \
        --test_output=errors \
